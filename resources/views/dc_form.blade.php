...
<head>
  ...
  <title>Datacard NOC Details Form</title>
  <!-- Bootstrap CSS -->
...
<body>
  <div class="container mt-5">
    ...
    <form id="datacard_form" action="" method="post"> @csrf
      <div class="row">
        <!-- First column -->
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="serviceProvider" name="serviceProvider" readonly value="Fetched from dataset">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="datacardNumber">Datacard Number</label>
            <input type="text" class="form-control" id="datacardNumber" name="datacardNumber" readonly value="Fetched from dataset">
          </div>
        </div>
      </div>
      <div class="row">
