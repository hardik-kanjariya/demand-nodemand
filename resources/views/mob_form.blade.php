        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" id="remark" name="remark" required>
              ...
              <option value="to be deposite at infocom Mehsana or next place of posting within 30 days from DOR">to be deposite at infocom Mehsana or next place of posting within 30 days from DOR</option>
              <option value="to be deposite at infocom Mehsana on or before DOR/DOS/DORSGN/DOVRS">to be deposite at infocom Mehsana on or before DOR/DOS/DORSGN/DOVRS</option>
              <option value="to be deposite at infocom Mehsana within 2 month from date of demise">to be deposite at infocom Mehsana within 2 month from date of demise</option>
            </select>
          </div>
        </div>
      </div>
