        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 rounded-5 d-flex justify-content-center align-item-center flex-column left-box" style="background: #103cbe;">
                <div class="featured-image mb-3 ">
                    <img src="ongc_logo.png" class=" image img-fluid rounded mx-auto d-block" >
            ...
            <div class="col-md-6  right-box">
                ...
                <div class="input-group mb-3">
                    <input name="username" type="text" class="form-control form-control-lg bg-light fs-6"  placeholder="Enter Username">
                </div>
                <div class="form-label"><label for="exinput" class="text-black fs-3">Password</label></div>
                <div class="input-group mb-1">
                    <input name="password" type="password" class="form-control form-control-lg bg-light fs-6" placeholder="Enter Password">
                </div>
