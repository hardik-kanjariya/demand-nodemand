...
<body>
  <div class="container mt-5">
    <h1 class="text-center mb-4">NOC Details Form For Telephone</h1>
    <form id="form_start" action=""> @csrf
      ...
      <div class="row">
        <!-- telephone Admin Department fields -->
        <div class="col-md-6">
          <div class="form-group">
            <label for="serviceProvider">Direct Landline (R)</label>
            <input type="text" class="form-control" id="serviceProvider" name="serviceProvider">
          </div>
          <div class="form-group">
            <label for="simNumber">Number</label>
            <input type="number" class="form-control" id="simNumber" name="simNumber">
          </div>
        </div>
      </div>
      <div class="row">
